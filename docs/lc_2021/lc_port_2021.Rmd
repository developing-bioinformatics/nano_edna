...
Sequencing relatively small datasets on Flongle flowcells provides insights and allows testing of methods at $70 per 5 amplicon sample costs. Table \@ref(tab:costtable). Pooling amplicon primer pools and increased multiplexing could further reduce costs.
...
cost_table[1, ] = c('DNA Extraction: DNEasy PowerWater Kit',
                    '$546 / 50 reactions x 5 amplicons each',
                    '$2.18')
...
cost_table[4, ] = c('Total per Amplicon',
                    '',
                    '$14.19')
cost_table[5, ] = c('Total per Sample (5 amplicons)',
                    '',
                    '~$71')
knitr::kable(
